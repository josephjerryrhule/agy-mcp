            ...
            text: JSON.stringify(
              {
                ...
                agent: 'codex',
                message:
                  'Codex task launched in background to avoid Claude Desktop 60-second MCP client timeouts. Call codex_check_task or agy_check_task with this task_id to check progress or get final results.',
                workspace_dir: task.workspaceDir,
              },
              null,
              2
            ...
            text: JSON.stringify(
              {
                ...
                message:
                  'Codex follow-up task launched in background to avoid Claude Desktop 60-second MCP client timeouts. Call codex_check_task with this task_id to check progress or get final results.',
                workspace_dir: task.workspaceDir,
              },
              null,
              2
